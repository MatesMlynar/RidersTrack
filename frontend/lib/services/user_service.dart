  ...
  Future<Map<String, dynamic>> login(String email, String password) async {
    ...
    http.Response response;
      ...
      try {
        ...
        response = await http.post(Uri.parse(dotenv.env['loginURL']!), headers: {"Content-type": "application/json"}, body: jsonEncode(reqBody)).timeout(const Duration(seconds: 15));
